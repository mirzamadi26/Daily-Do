import 'package:daily_do/models/task_model.dart'; // Import your task model
...
class EditTaskScreen extends StatelessWidget {
  final EditTaskController controller = Get.find<EditTaskController>();

  EditTaskScreen({Key? key, required this.task}) : super(key: key) {
    controller.titleCont.text = task.taskTitle;
    controller.dateCont.text = task.dueDate;
    controller.timeCont.text = task.time;
    controller.descCont.text = task.taskDescription;
    controller.dateCont.text = task.dueDate;
    controller.selectedCategory.value = task.category == 'Personal'
        ? 0
        : task.category == 'Work'
            ? 1
            : 2;
